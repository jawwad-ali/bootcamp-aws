...
export class Step19PinpointStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    // creating first step for step function
    const firstStep = new stepFunctionTasks.LambdaInvoke(this, "Invoke addData Lambda", {
      lambdaFunction: addData
    })

    // creating second step for step function
    const secondStep = new stepFunctionTasks.LambdaInvoke(this, "Invoke echoStatus", {
    ...
    // const wait = new stepFunctions.Wait(this, "Wait", {
